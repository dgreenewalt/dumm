var size = 0;
var placement = 'point';
function categories_tz2020_8(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'LAND HOOK':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(128,128,128,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2}),
...
case 'PARCEL LINE BEYOND':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,0,0,1.0)', lineDash: [10,5], lineCap: 'square', lineJoin: 'bevel', width: 2}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_tz2020_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_tz2020_8(feature, value, size, resolution, labelText,
